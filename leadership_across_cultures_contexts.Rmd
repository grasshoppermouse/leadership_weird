...
To test this idea, we operationalized the five elements using the leadership qualities cluster analysis (Figure \@ref(fig:cluster)A) as guidance (see Table \@ref(tab:leadermarket)). We then calculated the fraction of text records with evidence for one or more of the five elements. See Figure \@ref(fig:fivefold).
...
Figure \@ref(fig:fivefold) reveals that descriptions of leadership in the ethnographic record includes a heterogeneous mix of these five elements. In particular, not all leaders have evidence for high *Social capital*, leaders with *Cognitive capital* provide benefits *and* impose costs, and *Somatic capital* is rarely mentioned, but when it is, it is associated with providing benefits as well as imposing costs. Shamans are associated with evidence for *Cognitive capital* and imposing costs.
