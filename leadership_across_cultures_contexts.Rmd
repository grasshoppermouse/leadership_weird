...
**Leaders are managers**. In the absence of state-institutions local leaders are often tasked with managing various economic systems and providing social services. Within the domain of leader management, there are likely to be two primary features of human leader functions: strategizing and organizing. Our results correspond very closely to what @van_vugt_cognitive_2007 define as *strategic leadership*, where leaders increase the pay-offs of another individuals behavior thereby incentivizing followership versus *coordinating leadership*, where individuals bound by group challenges must effectively organize collective effort.
...
In recognizing the limitations of most extant psychological, sociological, and managerial data, many social scientists are now diversifying their samples across nations, cultures, and contexts to better understand *human* psychology, behavior, and culture. We caution that the WEIRD people problem in behavioral science cannot be remedied simply by a non-WEIRD solution. As our results, as well as much of anthropology and ethnography, demonstrate, within the populations that are now often coined a non-WEIRD, there is enormous diversity. Furthermore, larger order categories such as "subsistence strategy" are probably less relevant for understanding behavioral diversity than more salient group contexts. Despite limitations, the ethnographic record present an invaluable opportunity to explore patterns of human diversity and evolutionary theorists and researchers looking beyond WEIRD samples should take special interest in such methods.  
...
While there is a evidence of a "dominant" style of leadership involving coercive authority, confidence and aggression, as well as a "prestige" style involving special knowledge, experience, and innovation, we suggest rethinking models of leadership styles and focusing on inter-individual variation in specific competencies. There is likely to be substantial overlap in physical, spiritual, cognitive, and other prosocial endowments and the degree to which a leader relies on any will be shaped by their individual levels of such capacities, the presence and capacities of their rivals, as well as group context and cultural pressures. For example, widespread preferences for egalitarianism and social equality are likely strong drivers of leader preferences across diverse societies [@cheng_dominance_2019], but shamanism and ritual based contexts represent a social domain in which ideologies support a style of leadership fusing both dominance and prestige-based competencies. 
