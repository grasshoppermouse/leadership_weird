...
heatmap_drop1 + guides(fill='none') + heatmap_features_drop1 + plot_annotation(tag_levels = 'A')
```
...
We found strong evidence that several dimensions of leadership were universal across cultures, and across group contexts within cultures. Leaders function to resolve conflict, organize cooperation, and provide counsel and direction in over 70% of cultures, and are seen as high status, knowledgeable and intelligent, and experienced and accomplished in about 80% or more of cultures (see Figure \@ref(fig:varsupport)). Leaders benefited materially, reproductivly, and socially in 50% or more of cultures (see Figure \@ref(fig:varsupportcb)). Some common leadership dimensions also did not vary by the four factors we examined: group context, continental region, subsistence strategy, and leader sex. These dimensions included qualities, such as being knowledgeable and intelligent, wealthy, strategically nepotistic, and generous, and functions, such as resolving conflict and representing the group. These dimensions are therefore candidates for universal dimensions of human leadership. By "universal" we do not mean that all leaders have all these traits. Instead, we mean that there is evidence for these traits across a solid majority of cultures that does not vary much by the four factors. See Table \@ref(tab:leaderuniversals) and Figure \@ref(fig:varsupport).
...
Leaders can be conceptualized as performing three broad functions: providing goods and services (Prosocial), organizing collective actions, and 

The leadership "features" we derived by clustering our leadership dimensions were represented across most cultures. See Figure \@ref(fig:featuressupportplot). 

These potentially universal dimensions of leadership correspond to those highlighted by several evolutionary theories of leadership that have drawn heavily on select ethnographic cases [@garfield_review_2019]. They partially correspond to the prestige model [@henrich_big_2015; @henrich_evolution_2001], for example, which emphasizes knowledge, skill and generosity, but they do not include a key feature of that model: emulation of prestigous leaders [but see @garfield_investigating_2019]. These dimensions also partially correspond to the service-for-prestige model [@price_evolution_2014; @price_service-for-prestige_2015], but that model does not emphasize the concrete material benefits seen here. The absence of *High status* and *Aggressiveness* on this universal list corresponds to the reverse dominance hierarchy model [@boehm_egalitarian_1993], which emphasizes knowledge, intelligence, conflict resolution, generosity and status leveling mechanisms. 
...
Most potentially universal dimensions discovered here appear in a model developed by @hagen_leadership_2019, in which knowledgable and intelligent individuals provide computational (cognitive) services to group members in exchange for a variety of fitness benefits, and these services often involve conflict resolution and other social functions [see also @garfield_evolutionary_2019]. But the computational services model emphasizes mating benefits, which appear in `r matingbenefit`% of cultures, which was below our arbitrary 60% threshold for "universality". See Figure \@ref(fig:varsupportcb).

Pawnee chiefs illustrate leadership involving several of the universal dimesions, including intelligence, conflict resolution, and generosity [@murrayXX]:
...
There was substantial cross-cultural variation in evidence for most dimensions of leadership: of our `r length(all_study_vars)` dimensions of leadership, `r sum(df_compare2$Estimate < 0.5)` had evidence in less than 50% of our `r nrow(leader_cult)` cultures. See Figures \@ref(fig:varsupport) and \@ref(fig:varsupportcb). There was *systematic* variation in `r vary_n` leadership dimensions by continental region, subsistence, strategy, group context, and/or leader sex, factors for which we had complete data for all text records. Interestingly, these systematically varying dimensions tended to be associated with one factor above the others. See Figure \@ref(fig:heatmapdrop1). The clearest pattern to emerge from these analyses is that, not too surprisingly, many dimensions of leadership are context-specfic: Aggressiveness and Bravery were associated with military groups, Supernatural and Ritual functions were associated with religious groups, Organizing cooperation and Experience/accomplished were associated with economic groups, and Providing counsel and older Age were associated with kin groups. See Figure \@ref(fig:heatmapgroups).
