...
```{r fivefold, fig.width=10, fig.cap="The intersections of evidence for our five basic elements of leadership among all text records (an 'upset' plot) [@gehlenborg2019]. Horizontal bars (left): The total number of text records in each element. Dots (bottom): Elements that both have evidence (intersection). Vertical bars (top): The number of text records in that intersection. Red: The number of text records involving shamans or leaders with supernatural qualities. "}
