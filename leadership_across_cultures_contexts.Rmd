...
```{r leadertotalbenefits, fig.cap="Estimated marginal means of A. leader total benefits, and B. total costs, as a function of group structure, based on a logistic mixed effects regression model with random intercepts for ethnographer nested within culture. Values are on the response scale."}
# p1 <- 
...
theplot <- all_emms(m_status_group2, c('subsistence', 'group.structure2', 'region', 'demo_sex'), 0.8, 'Predictors of leader status')

((theplots[[1]] / theplots[[2]]) | (theplots[[3]] / theplots[[4]])) + plot_annotation(title = title, tag_levels = 'A')
```
