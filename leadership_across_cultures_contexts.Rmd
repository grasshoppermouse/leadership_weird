...
ZG then created a measure of group structure coded as: *residential subgroup*, which includes informal groups of co-residents, age-based groups, performance groups; *kin group*, which includes lineages, phraties, and other kin-based organizations; *economic group*, which includes subsistence groups, market groups, and other groups with primarily economic goals; *military group*, which includes all groups related to inter-group conflict; *religious group*, which includes groups collected for spiritual or supernatural purpose; *political group (community)*, which includes political groups at the level of the community, i.e., the political leader can potentially directly interact with most community members such as most village headmen, or *political group (supracommunity)*, which includes political groups that encompass multiple residential communities, such as complex chiefdoms, regional political leaders, and kings or state-level leaders. ZG and KS then coded all text records for group structure.
...
Subsistence strategy was confounded with continental region. African text records were predominantly from horticultural societies, for instance, whereas North American text records were predominantly from hunter-gatherer societies (see Figure \@ref(fig:regionsubsistence)).
...
*High status* was the most frequent leader quality in the ethnographic record, with `r statusPercTxt`% of text records and `r statusPercCult`% cultures containing evidence that leaders were of high social status. To explore factors that distinguished these records from those with no evidence for status, we first created a document-term matrix (DTM) of all "informative" words in our corpus of texts and the frequency with which they occurred in each text record (see SI for details). We then fit an elasticnet logistic regression model (with lasso penalty) of high status (0/1) as a function of the frequencies of all `r ncol(leader_dtm)-1` words. Words that were strong positive predictors epitomized the semantic content of the text records which provide evidence of high status as a quality of leaders. These included *`r rev(highstatus_plot$data$Word)[1]`* and *`r rev(highstatus_plot$data$Word)[2]`*, which were the terms with the strongest predictive values; *`r rev(highstatus_plot$data$Word)[3]`* and *`r rev(highstatus_plot$data$Word)[4]`* were also strong predictors and *`r rev(highstatus_plot$data$Word)[5]`* and *`r rev(highstatus_plot$data$Word)[6]`* were also positive predictors. Notable terms which offered predictive value but with near zero coefficients included, *influence*, *authority*, *headman*, and *chief*. See Figure \@ref(fig:highstatusplot).

We then investigated if the proportion of text records with evidence for high status differed among the different levels of social and political organization, subsistence strategies, continental regions, and leader sex (again using a logistic mixed effects model with these variables as fixed effects and authors nested within cultures as random intercepts). There were modest differences. Hunter-gatherers and pastoralists societies were more likely to provide evidence for high status, as was South America and East Asia. Female leaders were also more likely to be identified as high status. Somewhat counter-intuitively, the proportion of text records indicating high status was lowest at the highest level of political organization, perhaps because it would have been superfluous to note that kings and chiefs were high status. See Figure \@ref(fig:groupstatus). For the table of coefficients, see Supplementary Table X.
...
The distribution of text records by group and subsistence type suggests leaders emerge within similar social domains among populations with varied subsistence strategies, but at variable frequencies. See Figure \@ref(fig:grouptype). 
...
The Prosocial qualities cluster comprised subclusters we labeled, "Cultural conformity" and "Prosocial competencies", the later of which included a mix of positive personal traits, such as generosity and proper behavior, as well as interpersonal skills, having a favorable personality, oratory skill, and charisma, which generally correspond to a charismatic style of leadership that has been identified in industrialized settings and widely discussed in sociology and more recently emphasized in evolutionary psychology models of leadership [@den_hartog_culture_1999; @weber_distribution_1978; @grabo_charismatic_2016; @howell_role_2005]. The larger Prosocial qualities cluster also correspondes to @henrich_big_2015's Big-man mechanism, which suggests positive assortment of followers to prosocial leaders can facilitate the evolution of cooperative social norms and prestige-based leadership. A few variables did not seem to fit prosocial theme, however, such as *Physical health*, *Physical fromidable*, and *Drug consumption* (although drug use is often an important social activity).

The three most frequent leader quality variables were found in the Individual qualities cluster, which had two smaller and strongly supported subclusters: "Social, reproductive, and material success", which included traits indicative of the benefits of successful leadership, and a more general "Competencies" cluster which included qualities that are not necesssarily prosocial. Leaders, probably as a consequence of their ability to provide social benefits and impose social costs, are also characterized by their material, social, and reproductive success (bottom cluster Figure \@ref(fig:cluster)A), which is consistent with much of the theoretical literature focused on associated outcomes of leadership and social hierarchy [e.g., @von_rueden_mens_2016; @bowles_emergence_2010; @glowacki_role_2013]. Again, some variables in this subcluster, such as *Ingroup member* and *Loyalty*, did not quite fit the theme. Several of these measures of success often co-occur. Among the Trobriands, horticulturalists in Papua New Guinea, @ol06-037 [p. 47] describes relationships between polygynous marriages, increased wealth, and widespread social contacts: 
