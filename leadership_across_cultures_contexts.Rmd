...
```{r fivefold, fig.width=10, fig.cap="The intersections of evidence for our five basic elements of leadership among all text records (an 'upset' plot) [@gehlenborg2019]. Horizontal bars (left): The total number of text records in each element. Dots (bottom): Elements that both have evidence (intersection). Vertical bars (top): The number of text records in that intersection (with lower limit set at 3). Red: The number of text records involving shamans or leaders with supernatural qualities. "}
...
As Figure \@ref(fig:fivefold) reveals, descriptions of leadership in the ethnographic record includes a heterogeneous mix of these traits. In particular, not all leaders have evidence for high *Social capital*, leaders with *Cognitive capital* provide benefits *and* impose costs, and *Somatic capital* is rarely mentioned, but when it is, it is associated with providing benefits as well as imposing costs. Shamans are associated with evidence for *Cognitive capital* and imposing costs.
