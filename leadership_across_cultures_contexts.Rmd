...
Leadership dimensions for which leader sex significantly improved fit. Note that very few text records (N=`r sum(all_data$demo_sex=='both')`) explicitly mentioned both male and female leaders. Hence, although not depicted here, the confidence intervals for the estimated marginal means for this level are wide.
