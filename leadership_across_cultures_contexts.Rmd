...
Our systematic cross-cultural results support many aspects of influential evolutionary theories of leadership. 
...
**Leader success**. Leaders, probably as a consequence of their ability to provide social benefits and impose social costs, are also characterized by their material, social, and reproductive success (bottom cluster Figure \@ref(fig:cluster)A), which is consistent with much of the theoretical literature focused on associated outcomes of leadership and social hierarchy [e.g., @von_rueden_mens_2016; @bowles_emergence_2010; @glowacki_role_2013]. Several of these measures of success often co-occur. Among the Trobriands, horticulturalists in Papua New Guinea, @ol06-037 [p. 47] describes relationships between polygynous marriages, increased wealth, and widespread social contacts: 
...
The 60-culture Probability Sample Files of the HRAF developed by @naroll_proposed_1967 is based on culturally and geographically diverse populations which are well covered in the ethnographic record. The distribution of cultures, however, is not equal across categories of subsistence strategies; agriculturalists and horticulturalists are relatively overpresented compared to hunter-gatherers and pastoralists. The ethnographic sample of text developed in the *leadershipdata* package is also not equally balanced across all subsistence stragey categories. See Figure S\@ref(fig:subsisttree).
...
The distribution of cultures by subsistence stragegy across conteinetla region is also variable. In this sample, most African cultures are agriculturalists and most North American cultures are hunter-gatherers, for example. See Figure S\@ref(fig:regionsubsistence). 
