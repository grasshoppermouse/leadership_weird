...
**Leader success**. Leaders, probably as a consequence of their capacities to provide prosocial benefits (e.g., resolving conflicts and being generous) and/or impose social costs (e.g., punishing and aggressiveness), are also characterized by their material, social, and reproductive success (bottom cluster Figure \@ref(fig:cluster)A), which is consistent with much of the theoretical literature focused on associated outcomes of leadership and social hierarchy [e.g., @von_rueden_mens_2016; @bowles_emergence_2010; @glowacki_role_2013]. Several of these measures of success often co-occur. Among the Trobriands, horticulturalists in Papua New Guinea, @ol06-037 [p. 47] describes relationships between polygynous marriages, increased wealth, and widespread social contacts: 
...
While there is evidence of a dominace style of leadership involving coercive authority, confidence and aggression, as well as a prestige style involving special knowledge, experience, and innovation, we suggest rethinking dichotomous models of leadership styles and focusing on inter-individual variation in specific leadership competencies. There is likely to be substantial overlap in physical, spiritual, cognitive, and other prosocial endowments and the degree to which a leader relies on any of these capacities will be shaped by their individual levels of such capacities, the capacities of ptential rivals, as well as group context, their functions, and cultural norms. For example, widespread preferences for egalitarianism and social equality are likely strong drivers of followers preferences for leaders across diverse societies [e.g., @cheng_dominance_2019; @price_evolution_2014], but shamanism and ritual based contexts represent a social domain in which ideologies support a style of leadership fusing both dominance and prestige-based competencies. It seems evident that cultural forces and ideologies play important roles in shaping leadership styles and follower preferencesm including among WEIRD populations and in national political movements around the world [e.g., @mcdermott_leadership_2018; @inglehart_trump_2016].
