...
In our view, the dominance-prestige and "dual-process" models of leadership, while advancing the discipline, cannot easily account for shaman leaders nor "managers". In short, these models have conflated "benefits" with knowledge and expertise, and "costs" with physical formidability. Instead, as shaman leaders demonstrate, knowledge and expertise can both provide benefits and impose costs, and the same goes for physical formidability. The "dual" in dual process comes from the fact that one individual can influence others either by providing benefits or by imposing costs. Moreover, not all leaders have status (e.g., managers), and not all high status individuals are leaders. We therefore tenatively advance an alternative scheme whereby leaders possess some combination of knowledge/expertise and physical formidability which they use to provide benefits or impose costs. If their abilities to provide benefits or impose costs are exceptional relative to other group members, they gain status. Hence, we should be able to find examples of leaders with various combinations of these five elements. 

In our data, we combinded a subset of our leader dimensions into these five elements. We then calculated the fraction of text records with evidence for one or more of the five elements. See Figure \@ref(fig:fivefold).

```{r fivefold, fig.width=10, fig.cap=""}
