...
Anthropology, on the other hand, has been criticized for exoticizing and essentializing diverse "Others" as part of its colonial history [@said1979; @abu2008; @reyes-garcia_small-scale_2017]. @abu2008 [p. 470], for instance, notes that
...
Evolutionary scholars typically define leaders as individuals who maintain disproportionate influence over decision-making within groups [@von_rueden_leadership_2015], whatever the group may be. One outstanding question is the degree to which theoretically important dimensions of leadership vary between cultures and across social contexts. Leadership studies have focused on community or political leaders, often overlooking the nature of leadership and followership across social contexts and levels of social organization, such as among kin, economic, and military groups. A second outstanding question is what benefits *and* costs both leaders and followers incur. While the benefits leaders accrue for their services have received substantial attention -- fitness benefits in particular -- the costs of leadership for both leaders and followers have been relatively under-investigated [but see @cheng_dominance_2019; @price_evolution_2014; @glowacki_leadership_2015; @von_rueden_leadership_2014].
...
Each document from each culture was coded for date of publication and the sex of the ethnographer(s). For additional details on ethnographic sampling and creation of the database of leadership text records, see @garfield_evolutionary_2019.
...
The most common functions of leaders, documented in over 70% of cultures, were resolving conflicts, providing miscellaneous social functions, organizing various cooperative activities, and providing counsel or direction in follower's affairs. In about half of the cultures sampled here leaders punished other group members and managed economic systems. Functions notable for their rarity included controlling group movement and immigration.
...
This exploratory study systematically evaluated evidence for `r length(all_study_vars)` dimensions of leadership in a stratified random sample of the ethnographic record of `r nrow(leader_cult)` largely nonindustrial (non-WEIRD) cultures that included hunter-gatherers, pastoralists, horticulturalists, and agriculturalists. Results revealed universal dimensions of human leadership as well as important variation by group context, subsistence type, continental region, and sex of the leader.
...
This lends support to the notion of high social status often being a necessary condition of leader emergence [@cheng_why_2020]. Nevertheless, over two thirds of our text records on leadership did not mention status, and it was not one of our candidate universal dimensions of leadership. Interestingly, evidence for high status leaders varied by continental region, with more evidence for them from South American cultures (see Figure S\@ref(fig:heatmapregion)).
...
Leaders, possibly due to their special competencies, are able to devise and implement strategic solutions to group problems including resolving conflicts within the group (the most widely supported function in our sample) and providing counsel (also widely supported), which again are functions that are commonly noted in the anthropological and psychological leadership literature [@wiessner_risk_1982; @wiessner_collective_2019; @boehm_hierarchy_1999; @knauft_violence_1991; @de_cremer_intergroup_2002]. 
...
The feature of leader organizational functions aligns with the many evolutionary theories of leadership that emphasize the role of leaders in organizing collective actions [e.g., @hooper_theory_2010; @van_vugt_cognitive_2007; @glowacki_formation_2016; @pietraszewski_evolution_2019; for review, see @garfield_evolutionary_2019]. 
