...
Despite decades of research and theorizing about leadership in numerous social science disciplines, to our knowledge there is no comprehensive or systematic investigation of leader functions and qualities, and the costs and benefits of leadership and followership, across a representative sample of cultures. Moreover, most research on leadership is based on data from Western or Westernized societies.

<!-- WEIRD PEOPLE PROBLEMS -->
For well over a century, anthropology has systematically investigated nearly every extant culture. Research on leadership within anthropology dates to the inception of the discipline. Early on, anthropologists (and some sociologists) realized that leadership and followership were critical to understanding human psychology, social organization, and culture [e.g., @mumford_origins_1906; ]

Firth, 1927; Morgan, 1877; Myres, 1917]. Anthropologists documented some sort of leadership among every ethnographically studied culture [@brown_human_1991; @lewis_leaders_1974], and in many social contexts, such as families and kin groups (Dussart, 2000), ritual [@singh_cultural_2017], work groups [@macfarlan_competitive_2012], and conflicts between groups [@glowacki_evolutionary_2017]. For review, see @garfield_review_2019.



There is now well established consensus within behavioral and evolutionary human sciences on the importance of data from the full range of human cultural diversity and systemic biases in much of social science are well known [@henrich_weirdest_2010, *The weirdest people in the world?*]. @henrich_weirdest_2010 in their initial critique of the over-realiance on WEIRD samples emphasized a holistic approach to cultural diversity within and across "telescoping" levels of human societies, but also identified a contrast that, "compares people from modern industrialized societies with those from small-scale societies" (p.62), which has become the most salient interpretation of the paper and call-to-action. Since the seminal WEIRD people paper many social scientists have indeed taken up the challenge to diversify their samples and have sought out "non-WEIRD" participants and databases. However, categorizing populations as WEIRD or non-WEIRD and attempting to charachterize "non-WEIRD" social dynamics to learn about human psychology is a reductionist over-correction and arguably only a marginal scientific improvement from exclusively studying WEIRD populations.^[A Google Scholar search for "non-WEIRD" produced over 1000 results.] Extending the study of leadership to include evolutionary theory and data from diverse, small-scale and traditional societies (i.e., non-WEIRD) can facilitate more generalizable theories and offer applications to shape organizational structure across populations (i.e., WEIRD settings) in ways which are more consistent and less mismatched with human evolutionary history and evolved leader-follower psychologies [@von_rueden_leadership_2015; @garfield_review_2019; @van_vugt_selected_2010]. But such approaches are also at risk of failing to incorporate the message of the larger WEIRD people problem: diversity of cultural, social, and ecological contexts can be strong divers of human behavior and group dynamics.


Leaders substantially shape group structures and outcomes across cultures. The structure of groups and their goals, in turn, as well as their subsistence strategies, can favor particular leader qualities.


as well as the costs and benefits to individuals involved. Cultural norms, capacities of competing leaders, inter-group dynamics, and follower preferences can also impact leader agendas. The interactions between leader strategies, pressures of followership, and group dynamics are likely to strongly contribute to organizational variation across human populations including social and economic trajectories [@wiessner_risk_1982] and cultural and biological evolutionary processes [@henrich_big_2015].  

<!-- NOT SURE WHERE THIS SENTANCE SHOULD GO OR COULD BE CUT -->
Within every population there are particular contexts in which one or a few individuals maintain a disproportionate level of influence in the group, function to facilitate group goals, and provides services to the group.

<!-- EVOLUTIONARY THEORY APPROACH -->
Much scientific work across psychology, sociology, political science, and managerial studies has focused on trying to uncover the interrelationships of these dimensions of leadership. Until recently, this large body of work was relatively disconnected from approaches in anthropology and biology. Under a unifying evolutionary framework, social and biological scientists have now produced a sizable body of theory on the evolution and cross-cultural patterning of leadership and followership [e.g., @price_evolution_2014; @henrich_big_2015; @richerson_tribal_2009; @van_vugt_evolutionary_2006; @pietraszewski_evolution_2019; @hooper_theory_2010; @kaplan_evolutionary_2009; @von_rueden_roots_2014; @hagen_leadership_2019], accompanied by a growing body of empirical results [e.g., @bowser_womens_2010; @alami_mothers_2020; @cheng_two_2013; @redhead_dynamics_2018; @garfield_investigating_2019; @garfield_evolutionary_2019; @von_rueden_leadership_2014; @von_rueden_sex_2018; @smith_leadership_2016; @smith_obstacles_2018; @lonati_what_2019]. This integration as been informative [see @van_vugt_genes_2020].



<!-- GROUP CONTEXT and cost PROBLEMS -->
Much of leadership studies, including evolutionary approaches, have focused on community or political leaders, often overlooking subtilties in the nature of leadership and followership across social domains and levels of social organization, such as among kin groups, economic groups, and sub-groupings of individuals within residential communities. Lastly, while the benefits leaders accrue for their services have received substantial attention -- fitness benefits in particular -- the costs of leadership for both leaders and followers have been relatively under-investigated. Outstanding questions for evolutionary leadership scholars include the degree to which the nature of leadership is associated with population-level variation and in different social contexts and identifying the associated benefits *and* costs both leaders and followers incur.
<!-- CAN PULL SOME COST CITATIONS FROM NHB PAPER -->

<!-- THIS PARAGRAPH CAN BE INCORPORATED ABOVE ????? -->
Evolutionary scholars typically define leaders as individuals who maintain disproportionate influence over decision-making within groups [@von_rueden_leadership_2015], whatever the group may be. Leadership roles are also often associated with social sanctioned rights and responsibilities. Not surprisingly, the functions leaders serve then are often closely linked to group contexts and the salient challenges groups face. Certain types of groups, such as kin groups, economic groups, or political groups, may tend to favor leaders with specific qualities, however there can be substantial variation in the traits of leaders within these groups as well as between them. Adopting the broad definition of leadership given above, parents can also be defined as leaders of nuclear families. Strong community leadership, however, is extremely common cross-culturally including among hunter-gatherers and relatively small-scale societies [@garfield_review_2019; @von_rueden_leadership_2015]. 
...
Our third goal was to determine which leader and follower benefits and costs were most commonly mentioned in the ethnographic record, computing 95% CIs as above and to estimate which group structure types were associated with the most overall benefits and costs for leaders.
...
*High status* was the most frequent leader quality in the ethnographic record, with `r statusPercTxt`% of text records and `r statusPercCult`% cultures containing evidence that leaders were of high social status. To explore factors that distinguished these records from those with no evidence for status, we first created a document-term matrix (DTM) of all "informative" words in our corpus of texts and the frequency with which they occurred in each text record (see SI for details). We then fit an elasticnet logistic regression model (with lasso penalty) of high status (0/1) as a function of the frequencies of all `r ncol(leader_dtm)-1` words. Words that were strong positive predictors epitomized the semantic content of the text records which provide evidence of high status as a quality of leaders. These included *`r rev(highstatus_plot$data$Word)[1:4]`*, and *`r rev(highstatus_plot$data$Word)[5]`*. See Figure \@ref(fig:highstatusplot).

We then investigated if the proportion of text records with evidence for high status differed among the different levels of social and political organization. There were modest differences. Somewhat counter-intuitively, the proportion of text records indicating high status was lowest at the highest level of political organization, perhaps because it would have been superfluous to note that kings and chiefs were high status. See Figure \@ref(fig:groupstatus).

```{r groupstatus, fig.width=10, fig.cap="Estimated marginal means of a mixed effects logistic regression model of evidence for high status (0/1) as a function of group type, with random effects for ethnographer nested within culture."}
...
Finally, we examined the relationship between evidence for high status and subsistence strategy and continental region. See Figure \@ref(fig:statusregion).

```{r statusregion, fig.cap="Estimated marginal means of a mixed effects logistic regression model of evidence for high status (0/1) as a function of subsistence strategy and region as covariates, with random effects for ethnographer nested within culture."}
```
...
Leadership and high social status are expected to be associated with particular suites of characteristics, which potentially vary by cultural or social context, personality, or via other inter-individual variation [@cheng_two_2013; @von_rueden_roots_2014; @hogan_personality_2020; @lukaszewski_extraversion_2015; @henrich_evolution_2001]. Exploratory cluster analyses reported here suggest multiple leadership phenotypes. 

We performed hierarchical cluster analysis on our leader quality and leader function variables to determine if these variables formed theoretically meaningful categories. Variables were clustered together if they were positively correlated. Leader qualities formed two top-level clusters, which we identify as a *Material, social, and reproductive success* cluster, and a *Social orientation* cluster. See Figure \@ref(fig:cluster)A. Several of these traits often co-occur. Among the Trobriands, horticulturalists in Papua New Guinea, @ol06-037 [p. 47] describes relationships between polygynous marriages, increased wealth, and widespread social contacts: 
...
The remaining social benefit variables included a mix of positive personal traits, such as generosity and proper behavior, as well as interpersonal skills, having a favorable personality, oratory skill, and charisma, which correspond to a charismatic style of leadership that has been identified in industrialized settings and widely discussed in sociology and more recently emphasized in evolutionary psychology models of leadership [@den_hartog_culture_1999; @weber_distribution_1978; @grabo_charismatic_2016; @howell_role_2005]. A few variables did not seem to fit the social benefit theme, however, such as *Xenophobia* and *Drug consumption* (although drug use is often an important social activity).
...
Leaders, probably as a consequence of their ability to provide social benefits and impose social costs, are also characterized by their material, social, and reproductive success (top cluster, Figure \@ref(fig:cluster)A), which is consistent with much of the theoretical literature focused on associated outcomes of leadership and social hierarchy [e.g., @von_rueden_mens_2016; @bowles_emergence_2010; @glowacki_role_2013]. Again, some variables in this subcluster, such as *Ingroup member* and *Loyalty*, did not quite fit the theme.
