...
## The five-fold way OR Leadership markets

In our view, the dominance-prestige and "dual-model" theories of leadership, while advancing the discipline, cannot easily account for shaman leaders nor "managers". In short, these models have conflated "benefits" with knowledge and expertise, and "costs" with physical formidability. @van_vugt_dual_2019, for instance, state that the source of deference for prestige-style leadership is "Information asymmetry", and for dominance-style, "Power asymmetry" (their Table 1). Instead, as shaman leaders demonstrate, knowledge and expertise can both provide benefits and impose costs, and the same goes for physical formidability [e.g., @hawley_ontogenesis_1999; @hess_gossip_2017; @hess_sex_2006].

We therefore tenatively advance an alternative scheme whereby individuals possess some combination of knowledge/expertise and physical formidability which they use to provide benefits and impose costs. If their abilities to provide benefits or impose costs are exceptional relative to other group members, they gain status via biological market mechanisms [@hammerstein_biological_2016]. Hence, we should be able to find examples of leaders with various combinations of these five elements. 

In our data, we used the high status quality as "High status", the prosociality feature as "Provide benefits", any one of punishment, aggressive, feared, and killer as "Impose costs", knowledge/intellect and/or experience/accomplished as "Knowledge", and physically formidible and/or physically healthy as "Physical". We then calculated the fraction of text records with evidence for one or more of the five elements. See Figure \@ref(fig:fivefold).
...
[@hawley_ontogenesis_1999; @hawley_myth_2008]

Leaders vs. Status vs. Provide benefits vs. Impose costs vs. Information vs. Physical



We therefore suggest moving beyond dichotomous, or "dual-process", models of leadership.
