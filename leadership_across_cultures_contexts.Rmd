...
Overall, our results suggest that although high status leaders are common across cultures and all levels of social organization, only some leaders are high status, namely, those with a limited set of qualities such as wealth, experience, decision-making abilities, intelligence, and inter-personal skills, as well as older age and conformity to social norms.
...
In recognizing the limitations of most extant psychological, sociological, and managerial data, many social scientists are now diversifying their samples to better understand *human* psychology, behavior, and culture. We caution that the WEIRD people problem in behavioral science cannot be remedied simply by a "non-WEIRD" solution. As our results, as well as much of anthropology and ethnography, demonstrate, within the populations that are now often categorized as non-WEIRD, there is enormous diversity. Furthermore, larger order categories such as "subsistence strategy" are probably less relevant for understanding behavioral diversity than more salient group contexts. Despite limitations, the ethnographic record presents an invaluable opportunity to explore patterns of human diversity and evolutionary theorists and researchers looking beyond WEIRD samples should take special interest in comparative ethnographic methods.  

We found leaders in the ethnographic record are portrayed as generally prosocial, serve to resolve conflicts and organize cooperation, and receive material, social, and reproductive benefits. These results conform to the characteristics of leaders that are emphasized in the literature on the evolution of leadership and provide broad cross-cultural support for several influential theories, such as the prestige-dominance model, collective action models, the service-for-prestige model, and the computational services model [for review, see @garfield_evolutionary_2019].

While there is a evidence of a dominace style of leadership involving coercive authority, confidence and aggression, as well as a prestige style involving special knowledge, experience, and innovation, we suggest rethinking dichotomous models of leadership styles and focusing on inter-individual variation in specific leadership competencies. There is likely to be substantial overlap in physical, spiritual, cognitive, and other prosocial endowments and the degree to which a leader relies on any will be shaped by their individual levels of such capacities, the presence and capacities of their rivals, as well as group context, their functions, and cultural norms. For example, widespread preferences for egalitarianism and social equality are likely strong drivers of followers preferences for leaders across diverse societies [@cheng_dominance_2019], but shamanism and ritual based contexts represent a social domain in which ideologies support a style of leadership fusing both dominance and prestige-based competencies. We suspect cultural and pseudoreligous ideologies also play important roles in shaping leadership styles follower preferences among WEIRD populations and in national political movements around the world.
