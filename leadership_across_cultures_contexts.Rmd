...
```{r regionsubsistence, fig.width=11, fig.cap="Proportion of text records for different regions and subsistence types. Size of rectangles is proportional tothe number of text records."}
