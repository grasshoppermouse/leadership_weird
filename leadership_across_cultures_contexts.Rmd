...
**Leader success**. Leaders, probably as a consequence of their capacities to provide prosocial benefits (e.g., resolving conflicts and being generous) and/or impose social costs (e.g., punishing and aggressiveness), are also characterized by their material, social, and reproductive success (bottom cluster Figure \@ref(fig:cluster)A), which is consistent with much of the theoretical literature focused on associated outcomes of leadership and social hierarchy [e.g., @von_rueden_mens_2016; @bowles_emergence_2010; @glowacki_role_2013]. Several of these measures of success often co-occur. Among the Trobriand horticulturalists in Papua New Guinea, @ol06-037 [p. 47] describes relationships between polygynous marriages, increased wealth, and widespread social contacts: 
