...
Research on leadership within anthropology dates to the inception of the discipline. Early on, anthropologists (and some sociologists) realized that leadership and followership were critical to understanding human psychology, social organization, and culture [e.g., @mumford_origins_1906; @firth1927economic; @morgan_ancient_1877; @myres_influence_1917]. Anthropologists have documented some sort of leadership among every ethnographically studied culture [@brown_human_1991; @lewis_leaders_1974], and in many social contexts, such as families and kin groups (Dussart, 2000), ritual [@singh_cultural_2017], work groups [@macfarlan_competitive_2012], and conflicts between groups [@glowacki_evolutionary_2017]. For review, see @garfield_review_2019.

Despite decades of research and theorizing about leadership in numerous social science disciplines, to our knowledge there is no comprehensive or systematic investigation of leader functions and qualities, and the costs and benefits of leadership and followership, across a representative sample of cultures. Moreover, outside of anthropology, most research on leadership is based on data from Western or Westernized societies.

<!-- WEIRD PEOPLE PROBLEMS -->

There is now well established consensus within behavioral and evolutionary human sciences on the importance of data from the full range of human cultural diversity. Systemic biases in much of social science are well known [@henrich_weirdest_2010, *The weirdest people in the world?*], and might be due, in part, to the lack of data from non-WEIRD populations. @henrich_weirdest_2010 in their initial critique of the over-realiance on WEIRD samples emphasized a holistic approach to cultural diversity within and across "telescoping" levels of human societies. 
...
Anthropology, on the other hand, has been criticized for exoticizing and essentializing the "Other" [@said1979; @abu2008]. @abu2008 [p. 470], for instance, notes that
...
There is as much diversity within non-Western cultures as there is within Western ones, and there is also substantial overlap of the behaviors of people everywhere [@brown_human_1991].
