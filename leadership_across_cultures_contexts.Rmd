...
Across human societies, the influence and agendas of leaders stands to substantially shape group structure and group outcomes. The nature of group structure, group goals, and the demands of leadership can favor particular qualities of leaders as well as the costs and benefits to individulas. Cultural norms, capacities of competing leaders, inter-group dynamics, and followers preferences can also impact leader agendas. The interactions between leader strategies, pressures of followership, and group dynamics are likely to strongly contribute to organizational variation across human populations including social and economic trajectories [@wiessner_risk_1982] and cultural and biological evolutionary processes [@henrich_big_2015].  

Leadership has been the focus of much scientific work across psychology, sociology, political science, and managerial studies. Until recently, this large body of work was relatively disconnected from approaches in anthropology and biology. Under a unifying evolutionary framework, social and biological scientists have now produced a sizable body of theory on the evolution and cross-cultural patterning of leadership and followership [e.g., @price_evolution_2014; @henrich_big_2015; @richerson_tribal_2009; @van_vugt_evolutionary_2006; @pietraszewski_evolution_2019; @hooper_theory_2010; @kaplan_evolutionary_2009; @von_rueden_roots_2014; @hagen_leadership_2019], accompanied by a growing body of empirical results [e.g., @bowser_womens_2010; @alami_mothers_2020; @cheng_two_2013; @garfield_investigating_2019; @garfield_evolutionary_2019; @von_rueden_leadership_2014; @von_rueden_sex_2018; @smith_leadership_2016; @smith_obstacles_2018; @lonati_what_2019]. This integration as been informative [see @van_vugt_genes_2020].

There is now well established consensus within behavioral and evolutionary human sciences on the importance of data from the full range of human cultural diversity and systemic biases in psychological sciences are well known [i.e., @henrich_weirdest_2010]. However, a categorization of populations as WEIRD or non-WEIRD and attempting to conceptualize "non-WEIRD" social dynamics to learn about human psychology is a reductionist correction and arguably only a marginal scientific improvement from exclusively studying WEIRD populations. Extending the study of leadership to include evolutionary theory and data from diverse, small-scale and traditional societies (i.e., non-WEIRD) can facilitate more generalizable theories and offer applications to shape organizational structure across populations (i.e., WEIRD settings) in ways which are more consistent and less mismatched with human evolutionary history and evolved leader-follower psychologies [@von_rueden_leadership_2015; @garfield_review_2019; @van_vugt_selected_2010]. 

Much of leadership studies, including evolutionary approaches, have focused on community or political leaders, often overlooking the nature of leadership and followership across social domains and levels of social organization, such as among kin groups, economic groups, and sub-groupings of individuals within residential communities. Lastly, while the benefits leaders accrue for their services have received substantial attention -- fitness benefits in particular -- the costs of leadership for both leaders and followers have been relatively under-investigated. Outstanding questions for evolutionary leadership scholars include the degree to which the nature of leadership is associated with population-level variation and in different social contexts and identifying the associated benefits *and* costs both leaders and followers incur.
...
Substantial evidence suggests there is a near universal male-bias in community, political, or group-level leadership across human societies [@low_sex_1992; @whyte_status_1978; @sanday_female_1981], as well as across diverse non-human social species [@smith_obstacles_2018; @tiger_female_1978]. @low_sex_1992 found in a systematic cross-cultural sample that in only seven of 93 societies political leaders of both sexes were present and in only two societies were female political leaders identified as equally powerful as their male counterparts. Even among these rare cases, powerful female political leaders are still infrequent within the group. Women were more likely to hold influential leadership positions within kin groups [@low_sex_1992]. More recently, empirical studies have suggested sex-differences in political influence and leadership across human societies including among more egalitarian cultural contexts are more likely driven by ecological and social structural factors, rather than sex (or gender identity) per se, including social capital and access to same-sex allies [@yanca_female_2004] and/or sex differences in the sexual division of labor [@von_rueden_sex_2018]. Ethnographic fieldwork comparing leaders and non-leaders in two distinct small-scale societies has revealed sex is not a strong predictor of community influence or elected leadership positions, after accounting for a broad range of demographic, phenotypic, cognitive, social, and other traits derived from the evolutionary theoretical literature [e.g., @garfield_investigating_2019; @von_rueden_sex_2018]. 
...
With an interpretable method of dimensionality reduciton, we aimed to predict variation in our "feature" dimensions from populaiton-level variation, such as subsistence type, region, and group structure.
...
To supplement results from the aforementioned methods, we also performed textual analyses and explored varition measures of biases stemming from the ethnographic record that may have impacted results.
