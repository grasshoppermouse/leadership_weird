...
We found strong evidence that several dimensions of leadership were universal across cultures, and across group contexts within cultures. Leaders function to resolve conflict, organization cooperation, and provide counsel and direction in over 70% of cultures, and are seen as high status, knowledgeable and intelligence, and experienced and accomplished in about 80% or more of cultures. See Figure \@ref(fig:varsupport). Leaders benefitted materially, reproductively, and socially in 50% or more of cultures. See Figure \@ref(fig:varsupportcb). Common leader dimensions that did not vary by continental region, subsistence strategy, group context, or leader sex included qualities, such as being knowledgeable and intelligence, wealthly, strategically nepotistic, and generous; and functions, such as resolving conflict and representing the group. These dimensions are therefore candidates for universal dimensions of human leadership. By "universal", we do not mean that all leaders have all these traits. Instead, we mean that there is a fairly high level of evidence for these traits across cultures that does not vary by continental reagion, subsistence strategy, group context, or leader sex. See Table \@ref(tab:leaderuniversals).

Evidence for many leadership dimensions did vary across cultures and contexts, however, including functions such as organizing cooperation, providing counsel and direction and prosocial investment; and qualities such as high status and aggressiveness. See Figure \@ref(fig:heatmapdrop1).
