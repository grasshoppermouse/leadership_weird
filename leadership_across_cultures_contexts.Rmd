...
As discussed in the main text, we constructed `r length(features)` "feature" variables from the higher-level clusters (Figure \@ref(fig:cluster)): `r paste(features, collapse = ', ')`. The *Strategize*, *Prosociality*, and *Organize* features were modestly positively correlated with each other, but not with *Competencies*, *Proscoial competencies*, or *Social, reproductive, material success* features. The *Prosocial competencies* feature was modestly correlated with *Cultural conformity* and *Competencies* was modestly correlated with both the *Prosical competentcis* and *Social, reproductive, material success* features. See Figure \@ref(fig:featurecor).

We also explored the degree to which our feature variables varied by our four factors by comparing similar mixed effects models with either only intercepts or wiht the four factors. See Table \@ref(tab:featurecoefs) for AIC values and coefficents. The *Cultural conformity* feature model was not improved by the inclusion of the four factors as predictors, however the models predicting the other `r (length(features)-1)` feature variables were improved with the predictive factors (see Figure \@ref(fig:heatmapdrop1)B in the main text. We again used drop1 AIC comparison to identify which factors improved the models. Only leader sex and group structure improved model fit. See Figure \@ref(fig:heatmap_feature_sex) and Figure \@ref(fig:heatmapfeaturegroups). These results largely correspond to interpretations of our leadership dimension models previously discussed. 
