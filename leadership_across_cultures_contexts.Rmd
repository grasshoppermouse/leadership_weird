...
There are some broad commonalities in the qualities of community leaders across culturally and economically diverse populations. When strong community leaders emerge, they are most typically high status males who embody the ideal qualities most respected by the group and necessary for successful leadership in the domains in which they have influence [@henrich_evolution_2001; @van_vugt_evolutionary_2006; @collier_politics_1981; @low_men_1992; @roscoe_social_2019]. There has been increasing interdisciplinary discussion and consensus on the closely related topics of social status, power, authority, rank, prestige, and leadership [e.g., @blader_whats_2014; @cheng_dominance_2019; @kantner_identifying_2010; @von_rueden_roots_2014]. We draw on discussions by @blader_whats_2014 and @von_rueden_roots_2014 and conceptualize social status as a relative indicator of an individuals social value by the group and their access to contested resources within the group. The relationship between leadership (i.e., social influence) and status (i.e., social value) is expected to be colinear [@von_rueden_leadership_2015; @van_vugt_genes_2020], however, if there is causality between the two it is likely to be complex, context-specific, and driven by underlying correlates.

<!-- MALE BIAS -->
Substantial evidence suggests there is a near universal male-bias in community, political, or group-level leadership across human societies [@low_sex_1992; @whyte_status_1978; @sanday_female_1981], as well as across diverse non-human social species [@smith_obstacles_2018; @tiger_female_1978]. @low_sex_1992 demonstrated in a systematic cross-cultural sample that political leaders of both sexes were present in only seven of 93 societies and in only two societies were female political leaders identified as equally powerful as their male counterparts. Even among these rare cases, powerful female political leaders are still infrequent within the group and women were more likely to hold influential leadership positions within kin groups [@low_sex_1992]. Empirical ethnographic studies have suggested sex-differences in political influence and leadership across human societies including among more egalitarian cultural contexts are more likely driven by ecological and social structural factors, rather than sex (or gender identity) per se, including social capital and access to same-sex allies [@yanca_female_2004] and/or sex differences in the sexual division of labor [@von_rueden_sex_2018]. At least two studies relying on ethnographic fieldwork comparing leaders and non-leaders in relatively small-scale societies revealed sex is not a strong predictor of community influence or elected leadership positions, after accounting for a broad range of demographic, phenotypic, cognitive, social, and other traits derived from the evolutionary theoretical literature [e.g., @garfield_investigating_2019; @von_rueden_sex_2018]. 
...
With an interpretable method of dimensionality reduction, we aimed to predict variation in our "feature" dimensions from population-level variation, such as subsistence type, region, and group structure.
...
Our third goal was to determine which leader and follower benefits and costs were most commonly mentioned in the ethnographic record, computing proportions and 95% CIs as above and to estimate how costs and benefits varied by group structure types.
...
For each of the `r length(c(quality_vars, function_vars, leader_cost_vars, leader_benefit_vars, follower_benefit_vars, follower_cost_vars))` coded variables (see Tables \@ref(tab:qualfuncvars) and \@ref(tab:costbenefitvars)), we computed the proportion of text records (95% CI) that provided support using logistic mixed effects models that controlled for one possible source of bias -- publication date -- as a fixed effect, and included authors nested within cultures as random intercepts. We then computed the proportion of cultures with at least one text record providing support for that variable (calculating 95% CI using a cluster bootstrap). See Figure \@ref(fig:varsupport). For a table of all coefficients and 95% CIs, see Supplementary Table \@ref(tab:glmmcoefs).
...
The most common functions of leaders, documented in over 70% of cultures, were resolving conflicts, providing various social functions, organizing various cooperative activities, and providing counsel or direction in follower's affairs. Leaders were also commonly described as serving as a representatives in inter-group interactions, managing the distribution of resources, and providing context-specific leadership such as military command and in providing ritual services. In about half of the cultures sampled here leaders punished other group members and managed economic systems. Notable infrequent functions included controlling group movement and migrations.

The most common qualities of leaders were having high social status (documented in over 90% of cultures), being experienced or accomplished, and being described as knowledgeable or intelligent (documented in approximately 80% of cultures). Also, in about 60% of the cultures sampled here leaders were wealthy, nepotistic, possessed supernatural qualities, were generous, or maintained coercive authority over followers. Notable infrequent qualities of leaders in these data included physical formidability, having many social contacts, and being feared (documented in about 35% of cultures) and charisma and fairness (documented in about 20% of cultures).

## Benefits and costs of leadership and followership

The frequency of leader and follower costs and benefits were estimated similarly to the leader qualities and functions described above. In these data leaders most commonly receivied benefits in the form of greater access to material resources (documented in about 70% of cultures) and increased social status (documented in about 65% of cultures). Mating benefits and receiving social services were also relatively frequent benefits of leadership. In general, the costs tracked the benefits. Leaders were often described as losing their high social status (documented in about 45% of cultures) and greater access to resources (documented in about 40% of cultures). See Figure \@ref(fig:varsupportcb).

Followers on the other hand most commonly benefited from leadership systems through receiving material resources (documented in about 50% of cultures) but otherwise most frequently through social services provided (documented in about 35% of cultures). Mating and fitness benefits were relatively rare for followers. Followers were most frequently described as incuring costs in the form of material resources lost (documented in about 40% of cultures) and in providing social services (documented in about 25% of cultures). See Figure \@ref(fig:varsupportcb).
...
## Variation in study variables by subsistence strategy, continental region, leader sex, and group structure

To investigate variation in functions, qualities, costs, and benefits, we fit a multiple logistic mixed effects regression model of each variable as a function of subsistence strategy, continental region, leader sex, and group structure, with random intercepts for author nested within culture. We then compared the AIC value of each model to a model with only the fixed and random intercepts, retaining `r nrow(multi_aic)` models that showed at least a two-point reduction in AIC value. We then created heatmaps that displayed the relative estimated marginal means for each level of these categorical explanatory variables for each outcome variable. See Figures \@ref(fig:heatmapsubsis), \@ref(fig:heatmapregion), \@ref(fig:heatmapsex), and \@ref(fig:heatmapgroups), and Tables \@ref(tab:variablevars) and \@ref(tab:universalvars).

For subsistence strategy, hunter-gatherers had relatively more evidence for polygyny, mating benefits, no coercive authority, political appointments and military command than other subsistence strategies. Pastoralists had more evidence for ritual functions, supernatural, aggressiveness and high quality spouse. Hunter-gatherers and pastoralists both had more evidence for high status, providing counsel/direction, and providing subsistence. The remaining subsistence strategies generally had relatively less evidence for all variables, except that the mixed strategy had relatively more evidence for organizing cooperation, distributing resources, and prosocial investment. See Figure \@ref(fig:heatmapsubsis).

For continental region, there was little strong patterning, except that Africa generally had relatively less evidence for any retained variable except providing counsel/direction, and South America had relatively more evidence for several variables, including age, social services, and high status. See Figure \@ref(fig:heatmapregion).

There was strong patterning of relative evidence for almost all variables by leader sex. Female leaders had relatively more evidence for high quality spouse, mating benefit, polygyny, high status, and age. Male leaders had relatively more evidence for social services, political appointments, prosocial investment, and loss of social services. Records pertaining to both sexes had relatively more evidence for organizing cooperation, providing subsistence, ritual functions, bravery, experience/accompished, and few that overlapped with males, such as military command and distributing resources. See Figure \@ref(fig:heatmapsex).

There was also strong patterning of relatively evidence for almost all variables by group structure. There was relatively more evidence for military traits in military groups, relatively more evidence for ritual and supernatural traits in relgious groups, relatively more evidenc for organizing cooperation and providing subsistence in economic groups, and so forth. Kin groups had relatively more evidence for providing counsel/direction, prosocial investment, age, and high status. Community and residential groups had relatively low evidence for most variables, except that there was relatively more evidence for high quality spouses among residential group leaders. See Figure \@ref(fig:heatmapgroups).

## Total leader benefits and costs

We then explored relationships between total leader benefits and costs, summed across all leader benefit and cost variables, respectively, and levels of group context. In general, leaders at the highest supracommunity political level had the most evidence for receiving benefits and the least evidence for suffering costs and leaders of military groups has the highest total costs. See Figure \@ref(fig:leadertotalbenefits).

```{r leadertotalbenefits, fig.width=10, fig.cap="Estimated marginal means of A. leader total benefits, and B. total costs, as a function of group structure, based on a logistic mixed effects regression model with random intercepts for ethnographer nested within culture. Values are on the response scale."}
# p1 <- 
...
## When do leaders also have high status?
...
*High status* was the most frequently identified leader quality in the sample, with `r statusPercTxt`% of text records and `r statusPercCult`% of cultures containing evidence that leaders were of high social status. To explore factors that distinguished these records from those with no evidence for high status, we first created a document-term matrix (DTM) of all "informative" words in our corpus of texts and the frequency with which they occurred in each text record (see supplementary information for details). We then fit an elasticnet logistic regression model (with lasso penalty) of *High status* (0/1) as a function of the frequencies of all `r ncol(leader_dtm)-1` words. Words that were strong positive predictors epitomized the semantic content of the text records which provided evidence of high status as a quality of leaders. These included *`r rev(highstatus_plot$data$Word)[1]`* and *`r rev(highstatus_plot$data$Word)[2]`*, which were the strongest predictive terms; *`r rev(highstatus_plot$data$Word)[3]`* and *`r rev(highstatus_plot$data$Word)[4]`* were also relatively strong predictors and *`r rev(highstatus_plot$data$Word)[5]`* and *`r rev(highstatus_plot$data$Word)[6]`*, which were also positive predictors. Notable terms which offered predictive value but with near-zero coefficients included, *influence*, *authority*, *headman*, and *chief*. See Supplementary Figure \@ref(fig:highstatusplot).

We then investigated if the proportion of text records with evidence for *High status* differed among the different levels of group structure, subsistence strategies, continental regions, and leader sex (again using a logistic mixed effects model with these variables as fixed effects and authors nested within cultures as random intercepts). There were modest differences. Hunter-gatherers and pastoralists were more likely to provide evidence for high status leaders, as was South America and East Asia. Female leaders were also more likely to be identified as high status. Somewhat counter-intuitively, the proportion of text records indicating high status leaders was lowest at the highest level of political organization, perhaps because it would have been superfluous to note that kings and chiefs were high status. See Figure \@ref(fig:groupstatus). For the table of coefficients, see Supplementary Table X.

```{r groupstatus, fig.width=10, fig.cap="Estimated marginal means of a mixed effects logistic regression model of evidence for high status (0/1) as a function of group type, subsistence strategy, continental region, and leader sex, with random effects for ethnographer nested within culture. Values are on the response scale (probability)."}
...
Here we report the cluster analysis of variables that used the correlation distance metric ($1 - cor$), and the Ward agglomeration algorithm (for results from the other methods, see the supplementary information). Figure \@ref(fig:cluster)A displays a dendrogram from the cluster analysis of the `r length(quality_vars)` leader quality variables and Figure \@ref(fig:cluster)B displays a dendrogram from the cluster analysis of the `r length(function_vars)` leader function variables. Each cluster analysis includes two estimates of significance for how strongly each cluster within the dendrogram is supported by the data. We rely on the AU (Approximately Unbiased) *p* values, which are computed by multiscale bootstrap resampling and represented as percentages (e.g., clusters with AU values $>95$ are strongly supported, and the top-level clusters are automatically highlighted by rectangles).

```{r cluster, fig.cap="Cluster analysis of leader quality variables (A) and leader function variables (B). Distances were $1 - cor$. Ward agglomeration method. AU p-values (red) computed with 10,000 bootstrap samples using the pvclust package [@pvclust2015]."}
# plot(m_pvclust_qual)
# pvrect(m_pvclust_qual, alpha = 0.9)
knitr::include_graphics("Figures/m_pvclust.both.png")
```

The leader quality cluster analysis (Figure \@ref(fig:cluster)A) identified two top-level clusters, one that comprised mostly variables related to prosocial qualities and one that comprised other individual-level qualities which were not necessarily prosocial. Within the latter top-level cluster we identifed two interpretable and strongly supported subclusters which are annotated with text (*Social, reproductive, and material success* and *Competencies*). Within the first top-level cluster, we also identifed two subclusters, one of which contained meansures related to group-level pressures (*Cultural conformity*) and one which contined the prosocial traits (*Prosocial competencies*); these subclusters were moderately supported.

The leader functions cluster analysis (Figure \@ref(fig:cluster)B) also identified two top-level clusters; the larger of which we identified as a management functions cluster (i.e., *Organize cooperation*, *Military command*, *Resolve conflict* functions) and the smaller of which we identified as a prosociality cluster (i.e., *Social functions*, *Distribute resources*, *Hospitality* functions). Within the management cluster, we identified two moderately suppported subclusters; a *Mediation* subcluster (e.g., *Resolve conflict*, *Provide counsel*), and an *Organization* subcluster (e.g., *Organize cooperation*, *Military command*).

We identify these named subclusters as "features" of leader qualities and functions in the ethnographic record. In naming these features, we gave extra weight to variables that were strongly supported in the sample (Figure \@ref(fig:varsupport)), and therefore not all variables within these clusters were clearly related to the themes of each feature.

We then fit separate logistic mixed effects models of each feature as a function of subsistence strategy and region, with random effects for author nested within culture. After adjusting the subsistence coefficient p-values for an FDR of 0.05, we computed and plotted the estimated marginal means of the significant models. Two of these models (*Mediate* and *Prosocial competencies*) produced significant effects. See Figure \@ref(fig:features).

<!-- NEED TO DO -- ADD TABLE? -->

```{r features, fig.width=11, fig.cap="Esimtated marginal means [@lenth2020] of logistic mixed effects regression models of Feature variables by subsistence strategy and region. Only models whose subsistence coefficient had a corrected p-value < 0.05. The coefficient for region was also significant in the model of the 'Prosocial cometencies' feature. Plotted on the response (probablity) scale. See text for details."}

feature_scale <- scale_x_continuous(limits = c(0, 0.20))

p_subsis_mediate <- ggemmeans(subsis_models_sig$emmeans_subsis[[1]]) +
  feature_scale +
  labs(title = 'Mediate', x = '', y = '')

p_subsis_bigman <- ggemmeans(subsis_models_sig$emmeans_subsis[[2]]) +
  feature_scale +
  labs(title = 'Prosocial competencies', x = '', y = '')

p_region_mediate <- ggemmeans(subsis_models_sig$emmeans_region[[1]]) +
  feature_scale +
  labs(title = 'Mediate', x = '', y = '')

p_region_bigman <- ggemmeans(subsis_models_sig$emmeans_region[[2]]) +
  feature_scale +
  labs(title = 'Prosocial competencies', x = '', y = '')

(p_subsis_mediate + p_region_mediate) / (p_subsis_bigman + p_region_bigman)
...
This exploratory study extracted quantitative measures of the qualities, functions, benefits, and costs of leadership from the ethnographic record. The variables on leader qualities and functions were *not* determined prior to the study but were instead identified and coded during multiple passes through `r nrow(text_records)` texts on leadership obtained from the eHRAF (see Methods section). These data therefore represent the broadest and most comprehensive view of the qualities of leaders (i.e., the types of people that occupy leadership roles), the functions of leaders (i.e., what leaders do), and the costs and benefits of leadership for both leaders and followers across a diverse and culturally representative sample of the ethnographic record. Results revealed universal dimensions of human leadership as well as important variation by group context, subsistence type, and sex of the leader.

## Culture, context, and human leadership

The distribution of text records by group and subsistence type suggests leaders emerge within similar social contexts among populations with varied subsistence strategies, but at variable frequencies. See Figure \@ref(fig:grouptype). Exploratory analyses identified both universal and variable dimensions of human leadership across cultures and contexts. 
...
Exploratory modeling revealed variation in the vast majority (INCLUDE NO. or %) of our researcher coded variables (TABLEs) did not vary by group type or subsistence strategy (ajusting for effects of leader sex and continental region and the hierarchical structure of ethnographer within culture), suggesting that many of these dimensions of leadership are potnetially universal features of human social groups or at least not strongly impacted by the within or between-group measures investigated here. 

### Variable dimensions

Leadership in residential subgroups (e.g., social groups, performance groups) was relatively common among hunter-gatherers but relatively rare among agriculturists. Leadership at the supracommunity level, in contrast, was relatively rare among hunter-gatherers but quite common among agriculturists. The only example of supracommunity leadership among hunter-gatherers was from the Andamanese, a group of populations of Negrito hunter-gatherers of the Andaman Islands by [@az02-001, p. 45], who discussed the roles of a "head chief" from a permanent residential location and their marginal influence over other, local residential leaders (see quote in Methods section).

Hunter-gatherers and pastoralists, populations more likely to experience high residential mobility [@wild_making_2019; @rigby_persistent_1985; @kelly_foraging_2013], exhibited greater relative frequencies of leadership within residential groups and kin groups. Pastoralists, however, rely in part on a highly defensible resource base (i.e., livestock) and exhibit leadership beyond the community more so than hunter-gatherers and on par with horticulturalists. Pastoral and horticultural populations often experience elevated rates of inter-group conflict relative to mobile hunter-gatherers and these results are consistent with a relationship between increased inter-group conflict and more elaborated political leadership systems [@ember_warfare_1992]. For example, among the Somali, a politically complex and socially stratified agro-pastoralists group distributed across the Horn of Africa, @mo04-021 [p. 58] notes that, "the Sultan does not lead the army of the tribe in war. He names a chief of the armed forces."

Figure \@ref(fig:grouptype) is consistent with a negative relationships between political leadership at the community leadership or above and leadership in kin groups or residential groups. One possible interpretation is that as political structures become more institutionalized and economic systems transcend the household, leadership within households and residential groups diminishes. It is interesting, however, that even among the agricultural populations that are characterized by leadership systems beyond the community level, leadership within residential and family group persists. For example, among rural Korean populations a chairwomen of local organizations maintain important leadership positions within the groups and represent the group to governmental forces. @aa01-062 [p. 173] describes that in these local 'clubs', "the procedure of discussion and decision-making is not based on an idea of democracy but rather on that of unanimity. In this context, the ‘leader’ does not have to be a person of marked influence in the decision-making process. She is not a figurehead but rather a middleman in the meeting, functioning, in effect, as a go-between for the group. There is no despotic idea in the context of a total consensus in this essentially egalitarian society. The chairwoman stands as a middleman between the government and the village. Although the government may call her a ‘leader’ in the village, she properly does not occupy this role."
...
See Figure \@ref(fig:varsupport). These qualities and functions correspond to those highlighted by several evolutionary theories of leadership which have drawn heavily on select ethnographic cases [@garfield_review_2019]. See the *Synthesis* section below.
...
Several functions and qualities that are theoretically important were relatively rare in the ethnographic record. In the literature on leadership among non-human animals, for example, leaders commonly initiate group movement [@couzin_effective_2005], and "movement" was one of four leadership dimensions that @smith_leadership_2016 identified as comparable among humans and non-human animals, yet movement or migration was identified as a leader function in only `r movement_pct`% of cultures, of which the vast majority (71%) were hunter-gatherers. Among the Blackfoot in the North American plains for example, @nf06-061 [p. 411] describes that, "If there was a dispute as to whether the camp should move north or south, the chief might present his arguments, gain support, and then say that he was going south. He did not order the others to follow, but he knew that they probably would go with him." 

Several theories of leadership also emphasize the moral authority of leaders [e.g., @henrich_big_2015; @henrich_evolution_2001; @richerson_tribal_2009; @tietjen_moral_1985; @boggild_evolved_2016], yet leaders were seen as sources of moral authority or "fair" in only a minority of cultures (`r moral_pct`% and `r fairness_pct`% of cultures, respectively). The *Dominance* theory of leadership [e.g., @chapais_competence_2015; @cheng_dominance_2019; @cheng_pride_2010; @henrich_evolution_2001; @tiger_imperial_1971] emphasizes leaders' ability to instill fear, but in only `r feared_pct`% of cultures were leaders characterized as feared. Finally, a large literature on leadership in industrialized societies highlights the attractiveness of leaders [e.g., @sinclair_sexuality_1995; @altemeyer_sexual_1974; @march_leadership_2009], but leaders were characterized as attractive in only `r attractive_pct`% of cultures.

### Disentangling the relationship between leadership and high status

Relationships between leadership and high status, including dependencies and causality are puzzling and currently the focus of much work in evolutionary leadership studies [e.g., @van_vugt_dual_2019; @smith_leadership_2020; @cheng_why_2020; @cheng_dominance_2019; @von_rueden_dynamics_2019]. Drawing on a comparative-evolutionary perspective, incorporating findings from nonhuman social species, @van_vugt_dual_2019 emphasize that although leadership and high social status do indeed often covary, leaders are not necessarily high-status individuals, exemplified when low-ranking individuals in nonhuman species emerge as leaders of group movement or when younger and lower status men and women initiate cooperative activities (such as raids in tribal warfare or social-political movements). @cheng_dominance_2019 and @cheng_why_2020, emphasize, however, that social hierarchies form principally in response to inter-individual variation in status, which may be gained via distinct pathways. Thus, according to @cheng_why_2020, although all leaders are not necessarily high status, especially across nonhuman species, among humans high social status may be a necessary but insufficient condition for achieving and maintaing positions of leadership. In our view, social context is critical to these discussions, as is often mentioned but also under-emphasized and not well supported empirically. Processes of leadership and followership emerge across levels of social organization and individuals simultaneously maintain multiple social statuses. The "low status" male who initiates a inter-group raid on a neighboring group may not be widely respected within his community nor be a candidate for community leadership, however, he might be of exceptionally high status among his peers and high ranking within what @garfield_review_2019 [p. 71] called the "intragenerational social hierarchy."
...
This lends support to the notion of high social status often being a necessary condition of leader emergence [@cheng_why_2020]. In predicting the ethnographic texts which described leaders as high status, leaders of kin groups and leaders among hunter-gatherers and pastoralists were identified as more likely to be high status relative to some other group and subsistence types. Although discussions of female leaders were rare, the presence of female leaders were also associated with high social status (see Figure \@ref(fig:groupstatus)). Interestingly, political leaders were less likely to be described as high status, which could be related to institutionalized and overt or ascribed social distinctions. Nonetheless, these findings question the informed speculation by @smith_leadership_2020 that, "leadership may therefore be more strongly correlated with high status in large, complex organizations, such as in corporations and governments (p. 2)." However, our text analytic results, which relied on the semantic context of text records to predict the presence of high status leaders generally identified terms related to status and prestige (i.e., *respect*, *prestige*, *honor*) and possibly dominance or proscribed hierarchy (i.e., *rank*, *position*), as stronger predictors of high status leader than terms associated with leadership per se (i.e., *influence*, *authority*, *headman*), which lends some support to the distinction between status and leadership highlighted by @smith_leadership_2020 (though we caution from drawing strong interpretations from these text-analytic results, see Figure \@ref(fig:highstatusplot)). Overall, these results suggest associations between leadership and high status are ubiquitous across human societies, including among kin groups and among hunter-gatherers and that while effective leaders across a wide range of social contexts are the recipients of increased social status for their valuable services, ineffective leadership is associated with reduced social status. 

## Features of human leadership

We performed hierarchical cluster analysis on our leader quality and leader function variables to determine if these variables formed theoretically meaningful groups. Variables were clustered together if they were positively correlated. Leadership is expected to be associated with particular suites of characteristics and functions, which potentially vary by cultural or social context, personality, or via other inter-individual variation [@cheng_two_2013; @von_rueden_roots_2014; @hogan_personality_2020; @lukaszewski_extraversion_2015; @henrich_evolution_2001; @van_vugt_dual_2019]. Much of the evolutionary theoretical literature on leadership has suggested social influence is most often achieved via one of two distinct strategies: prestige or dominance. @van_vugt_dual_2019 [p. 1], for example, "argue that there are two leadership styles: prestige style and dominance style," and @cheng_two_2013 [p. 119] in focusing on dominance and prestige as two distinct leadership strategies suggest that, "human social stratification is characterized by the co-occurrence of both strategies." 

The dominance-prestige theory as formulated by @henrich_evolution_2001 significantly advanced evolutionary approaches to leadership and inspired much subsequent theoretical and empirical work. Exploratory cluster analyses reported here, however, suggest multiple features of leader qualities and leader functions across cultures and contexts, beyond dominance and prestige. Leaders likely rely a range of individual capacities, including physical, supernatural, and cognitive endowments, in order to organize group members, mediate problems, and provide prosocial services to the group, all while conforming to social and cultural pressures.

### Clusters of leader qualities

Leader qualities formed two top-level clusters, which we identify as a "Prosocial qualities" cluster, and an "Individual qualities" cluster, each of which contained two interpretable and generally supported subclusters. See Figure \@ref(fig:cluster)A. 

The Prosocial qualities cluster comprised subclusters we labeled, "Cultural conformity" and "Prosocial competencies", the later of which included a mix of positive personal traits, such as generosity and proper behavior, as well as interpersonal skills, having a favorable personality, oratory skill, and charisma, which generally correspond to a charismatic style of leadership that has been identified in industrialized settings and widely discussed in sociology and more recently emphasized in evolutionary psychology models of leadership [@den_hartog_culture_1999; @weber_distribution_1978; @grabo_charismatic_2016; @howell_role_2005]. The larger Prosocial qualities cluster also corresponds to @henrich_big_2015's Big-man mechanism, which suggests positive assortment of followers to prosocial leaders can facilitate the evolution of cooperative social norms and prestige-based leadership. A few variables did not seem to fit prosocial theme, however, such as *Physical health*, *Physical formidable*, and *Drug consumption* (although drug use is often an important social activity).

The three most frequent leader quality variables were found in the Individual qualities cluster, which had two smaller and strongly supported subclusters: "Social, reproductive, and material success", which included traits indicative of the benefits of successful leadership, and a more general "Competencies" cluster which included qualities that are not necessarily prosocial. Leaders, probably as a consequence of their ability to provide social benefits and impose social costs, are also characterized by their material, social, and reproductive success (bottom cluster Figure \@ref(fig:cluster)A), which is consistent with much of the theoretical literature focused on associated outcomes of leadership and social hierarchy [e.g., @von_rueden_mens_2016; @bowles_emergence_2010; @glowacki_role_2013]. Again, some variables in this subcluster, such as *Ingroup member* and *Loyalty*, did not quite fit the theme. Several of these measures of success often co-occur. Among the Trobriands, horticulturalists in Papua New Guinea, @ol06-037 [p. 47] describes relationships between polygynous marriages, increased wealth, and widespread social contacts: 
...
The Competencies subcluster contained a grouping of variables associated with dominance-based leadership, including *Coercive authority* and *Aggressiveness* [@tiger_imperial_1971; @barkow_prestige_1975; @barkow_darwin_1989; @henrich_evolution_2001; @cheng_two_2013] as well as a grouping that included *Knowledgeable/intelligent* and *Experienced/accomplished*, variables that have been emphasized by the *Prestige* theory [@henrich_evolution_2001; @cheng_two_2013] and the more general *Computational services* theory [@hagen_leadership_2019; @garfield_evolutionary_2019], and which are among the most strongly supported in the ethnographic record (Figure \@ref(fig:varsupport)), a point to which we shall return. Interestingly, *Feared* and *Supernatural* clustered more closely with the prestige-style traits than with the dominance-style traits. There is likely a strong connection between shamanism and ritual-based influence and both prestige and dominance styles of leadership. Ritual and supernatural capacities may represent a dimension of leader qualities in which dominance and prestige are coupled forming an alternative style of leadership. Artistic performance is also implicated in this style of leadership and ceremonial, artistic performances by shamans are common displays which often incorporate the superhuman abilities of shamans [@singh_cultural_2017]. 

As brief examples of the very many in the ethnographic record, among the Azande, "though the most knowledgeable witch-doctors tend to become leaders, there is no institutionalized organization or leadership among them" [@fo07-056, p. 85]; and among the Highland Scots, @es10-003 [p. 147] notes, "on the whole, their long ties with place and people, coupled with education, made them useful leaders of a community in which leaders were needed to adapt life to a changing economy." Such exceptionally talented leaders, however, also face unique challenges, particularly within more egalitarian societies which emphasizes personal autonomy and resit hierarchy in the context of cultural transitions. @nm09-056 [p. 183] describes Laura Cornelius Kellogg (also known as Minnie and Wynnogene, 1880-1947), a land-claims activist, writer, and perhaps the most famous female leader among the Iroquois:
...
The management cluster included many more variables, which were grouped into two subclusters that we identified as "Mediation" and "Organization". The mediation subcluster included variables such as *Resolve conflict* (the most widely supported function in our sample) and *Provide counsel* (also widely supported), which again are functions that are commonly noted in the anthropological literature [@wiessner_risk_1982; @wiessner_collective_2019; @boehm_hierarchy_1999; @knauft_violence_1991], and concerning conflict resolution specifically, widespread among nonhuman animals as well [@smith_leadership_2016; @smith_obstacles_2018; @wilson_sociobiology:_1980]. Among the Mbuti, hunter-gatherers in the Congo Basin known for strong cultural values of personal autonomy and egalitarianism, @fo04-001 [p. 185] describes the nature of conflict resolution processes in the absence of strong authority: 
...
```{r regionsubsistence, fig.width=11, fig.cap="Proportion of text records for different regions and subsistence types. Size of rectangles is proportional to the number of text records."}
ggplot(all_data) + geom_mosaic(aes(x = product(subsistence, region), fill = subsistence)) + scale_fill_viridis(discrete = T) + theme_minimal(15)
```
...
We used lasso regression as a variable selection technique, which is especially useful when the number of predictors is much greater than the number of cases (i.e., $p > > n$). Lasso regression has a penalty or shrinkage term, $\lambda$: larger values of $\lambda$ retain more variables in the model, at the risk of over-fitting, whereas smaller values of $\lambda$ decrease the number of predictors retained in the model, at the risk of under-fitting. The optimal value of $\lambda$ can be estimated with cross-validation [@tibshirani_regression_1996; @zou_regularization_2005]. We used the glmnet package [@friedman_regularization_2010] to fit a lasso regression model to determine which words best predicted evidence for high status as a leader quality. We used tenfold cross-validation to choose the $\lambda$ parameter that minimized deviance. We then plotted all the non-zero coefficients (Figure \@ref(fig:highstatusplot)). 

```{r highstatusplot, echo=F, message=F, fig.width=8, fig.height=6, fig.align='center', fig.cap="Lasso logistic regression coefficients, which indicate the words whose frequencies in each text record best predicted evidence for the *high status* leader quality in each text record. Coefficients estimated with glmnet package using cross-validation to determine the optimal value of lambda [@friedman_regularization_2010]. Red values are positive predictors; purple values are negative predictors. X-axis is on a log 10 scale."}
...
## Relative effects of subsistence strategy, region, leader sex, and group structure on all variables

```{r heatmapsubsis, fig.cap="Heatmap of relative estimated marginal means of the levels of evidence for each outcome variable by each subsistence strategy. Estimated marginal means were standardized by rows, and therefore can only be compared within rows, i.e., the colors represent the relative amount of evidence across levels of the categorical predictor within the same outcome variable."}

plot(p_heatmap_subsis)
```

```{r heatmapregion, fig.cap="Heatmap of relative estimated marginal means of the levels of evidence for each outcome variable by each subsistence strategy. Estimated marginal means were standardized by rows. The colors therefore represent the relative amount of evidence within the same outcome variable."}

plot(p_heatmap_region)
```


```{r heatmapsex, fig.cap="Heatmap of relative estimated marginal means of the levels of evidence for each outcome variable by each subsistence strategy. Estimated marginal means were standardized by rows. The colors therefore represent the relative amount of evidence within the same outcome variable."}

plot(p_heatmap_sex)
```

```{r heatmapgroups, fig.cap="Heatmap of relative estimated marginal means of the levels of evidence for each outcome variable by each subsistence strategy. Estimated marginal means were standardized by rows. The colors therefore represent the relative amount of evidence within the same outcome variable."}

plot(p_heatmap_groups)
```
...
multi_aic %>% 
  ...
  arrange(Variable) %>% 
  kable(
  caption = 'Retained logistic mixed effects models of each variable as functions of subsistence strategy, continental region, leader sex, and group stuctures. Models were retained due to improvement in AIC values relative to an intercept-only model. Sum: the number of rows with evidence for the variable. uniAIC: AIC of intercept-only model. multiAIC: AIC of multivariate model. AIC_diff: difference in AIC values. P-values are the unadjusted p-values of each explanatory variable in the model.',
  digits = 2
  )
```
...
multi_allvars %>%
  ...
  arrange(Variable) %>% 
  kable(
  caption = 'Logistic mixed effects models that did not show improvement in AIC values relative to an intercept-only model. These study variables either did not vary much by subsistence strategy, continental region, leader sex, or group stuctures, or had little evidence. Sum: the number of rows with evidence for the variable. uniAIC: AIC of intercept-only model. multiAIC: AIC of multivariate model. AIC_diff: difference in AIC values. P-values are the unadjusted p-values of each explanatory variable in the model.',
  digits = 2
  )
...
<!-- ## Effects of subsistence strategy and region on function and quality variables -->

```{r varsubsisregion, fig.cap="Estimated marginal means of logistic mixed effects models of each leader function and quality variable as a function of subsistence strategy and region, with random effects for author nested within culture. These are the only models with significant coefficients for either subsistence strategy or region, after correcting p-values for an FDR of 0.05."}

# plot_morality_region / plot_prosocial_region
```
...
We constructed `r length(features)` "feature" variables from the higher-level clusters (Figure \@ref(fig:cluster)): `r paste(features, collapse = ', ')`. The Mediate, Prosociality, and Organize features were modestly positively correlated with each other, but not with Prestige or Social/material success. Big man was correlated with Cultural conformity. See Figure \@ref(fig:featurecor).
