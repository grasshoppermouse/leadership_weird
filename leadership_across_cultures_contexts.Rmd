...
While there is cross-cultural evidence of a dominance style of leadership involving coercive authority, confidence and aggression, as well as a prestige style involving special knowledge, experience, and innovation, we suggest rethinking dichotomous models of leadership styles and focusing on inter-individual variation in specific leadership competencies. There is likely to be substantial overlap in and interaction between physical, spiritual, cognitive, and other prosocial competencies and the degree to which a leader relies on such competencies will be shaped by their individual levels in them, the competencies of potential rivals, as well as their functions and group context, follower preferences, and cultural norms. For example, widespread preferences for egalitarianism and social equality are likely strong drivers of followers preferences for leaders across diverse societies [e.g., @cheng_dominance_2019; @price_evolution_2014], but shamanism and ritual based contexts represent a social domain in which ideologies support a style of leadership fusing both dominance and prestige-based competencies. It seems evident that cultural forces and ideologies play important roles in shaping leadership styles and follower preferences including among WEIRD populations and in national political movements around the world [e.g., @mcdermott_leadership_2018; @inglehart_trump_2016].

One interesting pattern that has not been widely discussed in the evolutionary literature on leadership is the role of shamans and their intersection, in our results, with the dominance and prestige styles of leadership. Our competencies cluster (Figure \@ref(fig:cluster)A) includes the *Supernatural* abilities dimension. @winkelman1987cross found that in 47% of societies sampled from the HRAF ($n = 43$) shamans were associated with providing decision-making services, a proscial and prestige-based computational service, and associated with military power, which is often associated with dominance. Providing ritual functions and military leadership are common (documented in over 50% of societies here) functions leaders serve (see Figure \@ref(fig:varsupport)).
...
```{r sexsubtable}
kable(sub_sex_tbl, 
      caption = 'Distributuon of text records by leader sex and subsistence strategy.')
```
