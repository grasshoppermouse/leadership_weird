...
In our revision, we initially included a paragraph in our concluding statement interpreting our overall findings in reference to Wofford's and GLOBE study results, i.e., attempting (albeit briefly) to tie in our (non-WEIRD) results to relevant findings from WEIRD settings. However, following all revisions and our expanded analyses the maintext was over 20,000 words. We therefore decided to move essentially all of our detailed review of leaderhsip in WEIRD settings to the SI. Now, this conclusion statement would be out of place. We do make a few very brief and general statements comparing non-WEIRD and WEIRD leadership, but direct readers to the SI for details. 
