...
We investigated three possible sources of bias: total number of pages of ethnography, year of publication of each document, and the presence or absence of a female author/co-author for each document. We found evidence for bias in reporting of evidence for 9 of 109 variables based on year of publication only. There was no convincing evidence of bias in any variable based on the total number of pages of ethnography or ethographer gender. Results now reported.
...
We have revised our introduction section, the discussion, and our conclsuion along these lines. We hope we have struck the right balance in identifying important common themes and patterns across most of the populations in our data, while doing justice to their differences.
...
We have now greatly revised our mansucript and more clearly explain that our exploratory analyses aim to uncover varition (or lack of variation), within "non-WEIRD" populations. We do briefly review relevant perspectives on leadership in WEIRD contexts (primarily in the introduction and to a lesser degree in our interpretations of results), but we do not aim to compare WEIRD and non-WEIRD leadership dynamics. 
...
We have substantially revised the mansucript and analyses regarding this point. We now include specific sections in the results, discussion, and SI which are focused on the relaitonship between leadership and high social statuts and we believe our empirical results here fit in well with much of the current evolutionary leadership literature. 
...
We have also substatially revised our analyses of the costs and benefits of leadership, including in the results and in our interprettaions. We compare the reletiave evidence for leader and follower benegits vs. costs in the mansucript and provide exploratory models on the total leader benefits and costs in the SI. 
...
We now include a paragraph in our conlcuding statement interpreting our overall findings in reference to Wofford's and GLOBE study results, i.e., attempting (albeit briefly) to tie in our (non-WEIRD) results to relevant findings from WEIRD settings. 
...
We now discuss sex-differences in community and political leadership, and refernce in greater deatils (albeit breif) the universal male bias in community leadership in the introuction and cite these works. We also include specific sections on female leadership and sex differences in the results and discussion.
...
We did not mean to imply shamans are often the *most* influential political leaders in this passage, only that managerial eliets (e.g., Stanish) are often associated with a special social status rooted in ideology. However, to this point we have now include a dedicated section in the results section to shaman leaders and directly address the reviewer's inquries. As we discuss, we see shamanism as a potentially important and overlooked leadership strategy. 
...
We explicity avoided making any predictions. We understand that our review of existing evidence and theory could be used to generate a number of predictions. But ultimatley, our empirical goals are simply to explore the data structure rather than test predictions. We now more make this point more clearly. 
...
The reviewer brings up an important point, i.e., the conceptual and operational overlap in many study variables, and specifically between various qualities and benifits. This is partly a consequence of our methodology, given the coding of qualities was purely driven by the ethngoraphic record whereas our coding of costs and benefits was sketched out a priori, based on evolutionary theory. 
...
We now briefly (but in greater detail then our initial subisson) discuss the prestige and compuational services theories and interpret our empirical results in reference to these two theories. See the discussion section on "Beyong dual models."
